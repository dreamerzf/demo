...
public class RedisUtil {
     ...
     * @return
     */
    public boolean scanDel(String prefix,long size){
        List<String> list =assembleScanKeys(prefix+"*",size);
        if(list.size()>0){
     ...
     * scan方式获取keys
     */
    public List<String> getKeysByScan(String prefix,long size){
        List<String> list =assembleScanKeys(prefix+"*",size);
        return list;
    }
    /**
     * scan方式获取values
     */
    public List<String> getValuesByScan(String prefix,long size){
        List<String> list =assembleScanValues(prefix+"*",size);
        return list;
    }
    /**
     * 组装 scan 的结果集
    ...
    public List<String> assembleScanValues(String pattern, Long limit) {
        Set<String> valueSet = scan2(redisTemplate, pattern, limit);
     ...
     * 组装 scan 的结果集
     */
    private Set<String> scan2(RedisTemplate redisTemplate, String pattern, Long limit) {
        return (Set<String>) redisTemplate.execute(new RedisCallback<Set<String>>() {
            @Override
            public Set<String> doInRedis(RedisConnection connection) throws RuntimeException {
